...
<task type="auto">
  ...
  <action>
Replace src/pages/index.astro content with the full landing page composition.
...
```
  ...
  <done>index.astro replaced with full landing page composition using all React islands, isHomepage={true} set for JSON-LD</done>
</task>
