...
All 6 tests must pass for this task to be complete.
  ...
  <verify>
1. Run tests: pnpm exec playwright test tests/islands.spec.ts
2. All 6 tests pass (0 failures)
...
echo "All tests should pass (6 passed, 0 failed)"
```
...
3. **Playwright tests pass:** All 6 tests in islands.spec.ts pass
