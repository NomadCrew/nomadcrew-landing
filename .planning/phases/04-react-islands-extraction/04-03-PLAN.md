...
>
  ...
  <div class="py-8 text-center text-gray-500 text-sm">
    ...
    <p>Test with valid/invalid emails to see state changes.</p>
  </div>
</BaseLayout>
```
...
3. Enter invalid email format - observe behavior
...
3. Footer.astro exists as pure Astro component (no imports, no motion)
4. pnpm run check passes without errors
5. /test-waitlist/ renders form with visible input and button
6. Form shows "Please enter your email" when submitting empty
