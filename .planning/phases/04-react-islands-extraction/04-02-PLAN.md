...
- Icon mapping handles all 4 feature icons
- TypeScript check passes
...
2. Dev server starts: pnpm run dev
...
2. Open http://localhost:4321/test-features/ - scroll to trigger whileInView
...
3. HeroSection renders with fade-in animation at /test-hero/
4. FeatureCard renders with hover lift animation at /test-features/
5. All 4 feature cards display with correct icons
